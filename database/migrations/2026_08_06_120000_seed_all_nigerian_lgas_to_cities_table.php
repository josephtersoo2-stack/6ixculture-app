...
return new class extends Migration
{
    public function up()
    {
        ...
        $nigeriaLgas = [
            ...
            'Benue' => [
                'Agatu', 'Apa', 'Buruku', 'Gboko', 'Guma', 'Gwer East', 'Gwer West', 'Katsina-Ala',
            ...
            'Kaduna' => [
                'Birnin Gwari', 'Chikun', 'Giwa', 'Igabi', 'Ikara', "Jema'a", 'Kachia',
            ...
            'Niger' => [
                ...
                'Gurara', 'Katcha', 'Kontagora', 'Lapai', 'Lavun', 'Magama', 'Mariga', 'Mokwa',
                'Moya', 'Paikoro', 'Rafi', 'Rijau', 'Shiroro', 'Suleja', 'Tafa', 'Wushishi'
            ],
            'Ogun' => [
                'Abeokuta North', 'Abeokuta South', 'Ado-Odo/Ota', 'Egbado North (Yewa North)',
                'Egbado South (Yewa South)', 'Ewekoro', 'Ifo', 'Ijebu East', 'Ijebu North',
                'Ijebu North East', 'Ijebu Ode', 'Ikenne', 'Remo North', 'Imeko Afon', 'Ipokia',
                'Obafemi Owode', 'Odogbolu', 'Odeda', 'Ogun Waterside', 'Shagamu'
            ],
            'Ondo' => [
            ...
            'Oyo' => [
                ...
                'Ibarapa East', 'Ibarapa North', 'Iddo', 'Iseyin', 'Itesiwaju', 'Iwajowa',
            ...
            'Plateau' => [
                ...
                'Kanam', 'Kanke', 'Langtang South', 'Langtang North', 'Mangu', 'Mikang',
        ...
        foreach ($nigeriaLgas as $stateName => $lgas) {
            $state = DB::table('states')->where('name', 'LIKE', $stateName)->first();
            if ($state) {
                foreach ($lgas as $lga) {
                    $exists = DB::table('cities')->where('state_id', $state->id)->where('name', $lga)->exists();
                    if (!$exists) {
